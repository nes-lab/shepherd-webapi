...
class VirtualSourceBase(param.Parameterized):
    ...
    interval_startup_delay_drain_ms = param.Number(0, bounds=(0, 10_000), allow_None=True)
    ...
    LUT_output_efficiency = param.List(efficiency_opt, item_type=param.Magnitude, bounds=(12, 12), allow_None=True)
